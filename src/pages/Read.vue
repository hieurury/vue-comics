        ...
        <!-- chi tiết truyện -->
         <div>
            <div class="text-4xl uppercase font-semibold flex items-center mb-8 border-b-2 border-slate-300 py-4">
                ...
                <h1 class="lg:text-5xl text-3xl font-extrabold text-slate-700">Truyện<small class="ms-2 font-semibold text-gray-500 italic">{{ comicData.name }} 
                    - 
                    <span class="text-orange-600">Chương {{ chapterData.chapter_name }}</span></small></h1>
            </div>
         </div>
        <!-- Hình ảnh chapter -->
